...
public class RegistroTransaccionInformeSalidaInventarioDTO {
    private String consecutivoGravado;
    private LocalDateTime fecha;
    private BigDecimal total;

    public RegistroTransaccionInformeSalidaInventarioDTO() {
    }
    public RegistroTransaccionInformeSalidaInventarioDTO(String consecutivoGravado, LocalDateTime fecha, BigDecimal total) {
